...
class TestPeerUtils(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with open(self.dummy_file_path, "wb") as f:
            f.write(b"A" * self.chunk_size)
            f.write(b"B" * self.chunk_size) 
            f.write(b"C" * 512)
    ...
    def test_01_file_hashing(self):
        ...
        self.assertEqual(len(self.dummy_file_hash), 64)
    ...
    def test_04_storage_add_file_to_share(self):
        ...
        self.assertIsNone(storage.get_chunk_path(self.dummy_file_hash, 3))
